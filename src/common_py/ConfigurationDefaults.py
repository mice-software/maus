...
SciFiPatRecCircleMinuitChi2Cut = 1000.0 # Chi^2 on pat rec minuit circle fit
...
SciFiPatRecLongMinuitChi2Cut = 320.0 # Chi^2 cut on pat rec minuit longitudinal fit
