            ...
            <body>  
			    ...
			    Substitution $Q9Polarity <xsl:value-of select="@polarity"/><xsl:text>
                           ...
                           // 
                            ...
                            <xsl:variable name="tof_0_file_replacement" select="MICE_Information/Other_Information/FileNumbers/Tof0FileNumber/@replacement"/>
                            <xsl:variable name="tof_1_file_replacement" select="MICE_Information/Other_Information/FileNumbers/Tof1FileNumber/@replacement"/>
                            <xsl:variable name="tof_2_file_replacement" select="MICE_Information/Other_Information/FileNumbers/Tof2FileNumber/@replacement"/>
                            <xsl:variable name="kl_file_replacement" select="MICE_Information/Other_Information/FileNumbers/KLFileNumber/@replacement"/>
                            <xsl:variable name="ckov_file_replacement" select="MICE_Information/Other_Information/FileNumbers/CkovFileNumber/@replacement"/>
                            <xsl:variable name="emr_file_replacement" select="MICE_Information/Other_Information/FileNumbers/EMRFileNumber/@replacement"/>
                            <xsl:variable name="tracker0_file_replacement" select="MICE_Information/Other_Information/FileNumbers/Tracker0FileNumber/@replacement"/>
                            <xsl:variable name="tracker1_file_replacement" select="MICE_Information/Other_Information/FileNumbers/Tracker1FileNumber/@replacement"/>
                            <xsl:variable name="absorber0_file_replacement" select="MICE_Information/Other_Information/FileNumbers/Absorber0FileNumber/@replacement"/>                            
                            <xsl:variable name="absorber1_file_replacement" select="MICE_Information/Other_Information/FileNumbers/Absorber1FileNumber/@replacement"/>                            
                            <xsl:variable name="absorber2_file_replacement" select="MICE_Information/Other_Information/FileNumbers/Absorber2FileNumber/@replacement"/>
                     
                            <xsl:for-each select="structure/volume/physvol"> 
                                Module <xsl:choose><xsl:when test="contains(file/@name, $tof_0_file_number)"><xsl:value-of select="ancestor::gdml/MICE_Information/Other_Information/GDML_Files/@location"/><xsl:value-of select="$tof_0_file_replacement"/></xsl:when><xsl:when test="contains(file/@name, $tof_1_file_number)"><xsl:value-of select="ancestor::gdml/MICE_Information/Other_Information/GDML_Files/@location"/><xsl:value-of select="ancestor::gdml/MICE_Information/Other_Information/FileNumbers/Tof1FileNumber/@replacement"/></xsl:when><xsl:when test="contains(file/@name, $tof_2_file_number)"><xsl:value-of select="ancestor::gdml/MICE_Information/Other_Information/GDML_Files/@location"/><xsl:value-of select="$tof_2_file_replacement"/></xsl:when><xsl:when test="contains(file/@name, $kl_file_number)"><xsl:value-of select="ancestor::gdml/MICE_Information/Other_Information/GDML_Files/@location"/><xsl:value-of select="$kl_file_replacement"/></xsl:when><xsl:when test="contains(file/@name, $ckov_file_number)"><xsl:value-of select="ancestor::gdml/MICE_Information/Other_Information/GDML_Files/@location"/><xsl:value-of select="$ckov_file_replacement"/></xsl:when><xsl:when test="contains(file/@name, $emr_file_number)">EMR/Calorimeter.dat</xsl:when><xsl:when test="contains(file/@name, $tracker0_file_number)"><xsl:value-of select="ancestor::gdml/MICE_Information/Other_Information/GDML_Files/@location"/><xsl:value-of select="$tracker0_file_replacement"/></xsl:when><xsl:when test="contains(file/@name, $tracker1_file_number)"><xsl:value-of select="ancestor::gdml/MICE_Information/Other_Information/GDML_Files/@location"/><xsl:value-of select="$tracker1_file_replacement"/></xsl:when><xsl:when test="contains(file/@name, $absorber1_file_number)"><xsl:value-of select="ancestor::gdml/MICE_Information/Other_Information/GDML_Files/@location"/><xsl:value-of select="$absorber_file_replacement"/></xsl:when><xsl:otherwise><xsl:value-of select="ancestor::gdml/MICE_Information/Other_Information/GDML_Files/@location"/><xsl:value-of select="substring-before(file/@name, '.')"/>.dat</xsl:otherwise></xsl:choose>
                                    { 
