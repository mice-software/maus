...
//Substitutions
                ...
                <xsl:for-each select="MICE_Information/Detector_Information/Diffuser">
                    Module <xsl:value-of select="ancestor::gdml/MICE_Information/Other_Information/GDML_Files/@location"/>iris<xsl:value-of select="Iris/@name"/><xsl:choose>
                        ...
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'4') and contains($diffuserThickness,'8')">_open.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'4') and contains($diffuserThickness,'10')">_open.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'4') and contains($diffuserThickness,'12')">_open.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'4') and contains($diffuserThickness,'14')">_open.dat</xsl:when>
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'4') and contains($diffuserThickness,'1')">_closed.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'4') and contains($diffuserThickness,'3')">_closed.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'4') and contains($diffuserThickness,'5')">_closed.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'4') and contains($diffuserThickness,'7')">_closed.dat</xsl:when> 
                        ...
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'3') and contains($diffuserThickness,'4')">_open.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'3') and contains($diffuserThickness,'8')">_open.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'3') and contains($diffuserThickness,'12')">_open.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'3') and contains($diffuserThickness,'1')">_open.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'3') and contains($diffuserThickness,'5')">_open.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'3') and contains($diffuserThickness,'9')">_open.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'3') and contains($diffuserThickness,'13')">_open.dat</xsl:when>
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'3') and contains($diffuserThickness,'2')">_closed.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'3') and contains($diffuserThickness,'6')">_closed.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'3') and contains($diffuserThickness,'10')">_closed.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'3') and contains($diffuserThickness,'4')">_closed.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'3') and contains($diffuserThickness,'3')">_closed.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'3') and contains($diffuserThickness,'7')">_closed.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'3') and contains($diffuserThickness,'11')">_closed.dat</xsl:when> 
                        ...
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'2') and contains($diffuserThickness,'2')">_open.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'2') and contains($diffuserThickness,'3')">_open.dat</xsl:when> 
                        ...
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'2') and contains($diffuserThickness,'10')">_open.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'2') and contains($diffuserThickness,'11')">_open.dat</xsl:when>
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'2') and contains($diffuserThickness,'4')">_closed.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'2') and contains($diffuserThickness,'5')">_closed.dat</xsl:when> 
                        ...
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'2') and contains($diffuserThickness,'12')">_closed.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'2') and contains($diffuserThickness,'13')">_closed.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'2') and contains($diffuserThickness,'14')">_closed.dat</xsl:when> 
                        ...
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'1') and contains($diffuserThickness,'1')">_open.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'1') and contains($diffuserThickness,'2')">_open.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'1') and contains($diffuserThickness,'3')">_open.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'1') and contains($diffuserThickness,'4')">_open.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'1') and contains($diffuserThickness,'5')">_open.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'1') and contains($diffuserThickness,'6')">_open.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'1') and contains($diffuserThickness,'7')">_open.dat</xsl:when>
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'1') and contains($diffuserThickness,'8')">_closed.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'1') and contains($diffuserThickness,'9')">_closed.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'1') and contains($diffuserThickness,'10')">_closed.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'1') and contains($diffuserThickness,'11')">_closed.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'1') and contains($diffuserThickness,'12')">_closed.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'1') and contains($diffuserThickness,'13')">_closed.dat</xsl:when> 
                        <xsl:when test="boolean($run_number) and contains(Iris/@name,'1') and contains($diffuserThickness,'14')">_closed.dat</xsl:when> 
