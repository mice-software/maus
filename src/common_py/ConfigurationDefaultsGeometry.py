...
keep_steps = False # set to true to keep start and end point of every track and
                   # every step point
simulation_geometry_filename = "/home/matt/maus-littlefield/src/common_py/geometry/Download/ParentGeometryFile.txt" # geometry used by simulation
...
GeometryDescription = "Quadrupole test case"
