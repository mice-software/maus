...
class MapCppTrackerReconTestCase(unittest.TestCase): # pylint: disable = R0904
    ...
    def testGoodProcess(self):
        ...
        test1 = ('%s/src/map/MapCppTrackerRecon/test_cosmic_spills.json' %
