...
namespace MAUS {
  ...
  void MapCppGlobalReconImport::_process(MAUS::Data* data_cpp) const {
	...
	// Import TOF spacepoints into global event
	...
	// Import tracker tracks into global event
	...
	// Import Ckov information into spacepoints for global event
	...
	// Import KL information into spacepoints for global event
