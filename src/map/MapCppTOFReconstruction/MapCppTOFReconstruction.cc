...
bool MapCppTOFReconstruction::level1_recon(Json::Value xDocDetectorData,
                                           Json::Value &xDocLevel1Recon) {
...
bool MapCppTOFReconstruction::level2_recon(Json::Value xDocLevel1Recon,
                                           Json::Value &xDocLevel2Recon) {
