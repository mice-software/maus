...
#ifndef _SRC_COMMON_CPP_CONVERTER_DATACONVERTERS_CPPJSONFOOTERCONVERTER_H_
#define _SRC_COMMON_CPP_CONVERTER_DATACONVERTERS_CPPJSONFOOTERCONVERTER_H_
#include "json/json.h"
 ...
 */
  class CppJsonFooterConverter : public ConverterBase<JobFooterData, Json::Value> {
  public:
    CppJsonFooterConverter()
