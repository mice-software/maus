...
#ifndef _SRC_COMMON_CPP_CONVERTER_DATACONVERTERS_JSONCPPFOOTERCONVERTER_H
#define _SRC_COMMON_CPP_CONVERTER_DATACONVERTERS_JSONCPPFOOTERCONVERTER_H
#include "json/json.h"
 ...
 */
  class JsonCppFooterConverter : public ConverterBase<Json::Value, JobFooter> {
  public:
    JsonCppFooterConverter()
