...
template<typename T> orstream& orstream::operator<<         (T&      d) {
  attachBranch(d, true , true);
  return *this;
}
template<>           orstream& orstream::operator<< <int>   (int&    d) {
  attachBranch(d, false, true);
  return *this;
}
...
template<>           orstream& orstream::operator<< <double>(double& d) {
  attachBranch(d, false, true);
  return *this;
}
template<>           orstream& orstream::operator<< <float> (float&  d) {
  attachBranch(d, false, true);
  return *this;
}
