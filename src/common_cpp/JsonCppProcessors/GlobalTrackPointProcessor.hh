...
/** @class GlobalTrackPointProcessor processor for TrackPoint */
class GlobalTrackPointProcessor : public ObjectProcessor<GlobalTrackPoint> {
 public:
    /** Constructor - registers the branch structure */
    GlobalTrackPointProcessor();

 private:
    IntProcessor int_processor_;
    DoubleProcessor double_processor_;
    ThreeVectorProcessor three_vector_processor_;
};
} // ~namespace MAUS
