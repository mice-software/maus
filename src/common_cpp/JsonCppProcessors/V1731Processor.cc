...
V1731Processor::V1731Processor()
    : _ldc_id_proc(), _max_pos_proc(), _part_event_number_proc(),
      _charge_mm_proc(), _equip_type_proc(), _channel_key_proc(),
      _charge_pm_proc(), _arrival_time_proc(), _phys_event_number_proc(),
      _position_min_proc(), _samples_proc(new IntProcessor),
      _time_stamp_proc(), _trigger_time_tag_proc(), _detector_proc(),
      _pulse_area_proc(), _geo_proc(), _pedestal_proc(), _channel_proc() {
    RegisterValueBranch
