...
#ifndef _SRC_COMMON_CPP_JSONCPPPROCESSORS_OBJECTPROCESSORNS_CONSTANTITEM_HH_
#define _SRC_COMMON_CPP_JSONCPPPROCESSORS_OBJECTPROCESSORNS_CONSTANTITEM_HH_
...
class ConstantItem : public BaseItem<ParentType> {
  public:
     ...
     *  @param is_required if the branch doesnt exist in json, throw Exception if
...
#include "src/common_cpp/JsonCppProcessors/Common/ObjectProcessorNS/ConstantItem-inl.hh"
#endif
