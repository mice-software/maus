...
#ifndef _SRC_COMMON_CPP_JSONCPPPROCESSORS_OBJECTPROCESSORNS_POINTERTREFARRAYITEM_HH_
#define _SRC_COMMON_CPP_JSONCPPPROCESSORS_OBJECTPROCESSORNS_POINTERTREFARRAYITEM_HH_
...
/** @class PointerTRefArrayItem pointer reference branch for a Cpp object
 *
...
class PointerTRefArrayItem : public BaseItem<ParentType> {
 public:
   ...
   *  or is NULL in C++, throw Exception if is_required is set to true when
...
#include "src/common_cpp/JsonCppProcessors/Common/ObjectProcessorNS/PointerTRefArrayItem-inl.hh"
#endif
