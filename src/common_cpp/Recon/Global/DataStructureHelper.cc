...
void DataStructureHelper::InitialiseNames() {
    ...
    _names_to_points["Undefined"] = kUndefined;
    _names_to_points["Virtual"] = kVirtual;
    _names_to_points["TOF0"] = kTOF0;
    _names_to_points["TOF0_1"] = kTOF0_1;
    _names_to_points["TOF0_2"] = kTOF0_2;
    _names_to_points["CherenkovA"] = kCherenkovA;
    _names_to_points["CherenkovB"] = kCherenkovB;
    _names_to_points["TOF1"] = kTOF1;
    _names_to_points["TOF1_1"] = kTOF1_1;
    _names_to_points["TOF1_2"] = kTOF1_2;
    _names_to_points["Tracker0"] = kTracker0;
    _names_to_points["Tracker0_1"] = kTracker0_1;
    _names_to_points["Tracker0_2"] = kTracker0_2;
    _names_to_points["Tracker0_3"] = kTracker0_3;
    _names_to_points["Tracker0_4"] = kTracker0_4;
    _names_to_points["Tracker0_5"] = kTracker0_5;
    _names_to_points["Tracker1"] = kTracker1;
    _names_to_points["Tracker1_1"] = kTracker1_1;
    _names_to_points["Tracker1_2"] = kTracker1_2;
    _names_to_points["Tracker1_3"] = kTracker1_3;
    _names_to_points["Tracker1_4"] = kTracker1_4;
    _names_to_points["Tracker1_5"] = kTracker1_5;
    _names_to_points["TOF2"] = kTOF2;
    _names_to_points["TOF2_1"] = kTOF2_1;
    _names_to_points["TOF2_2"] = kTOF2_2;
    _names_to_points["Calorimeter"] = kCalorimeter;
    _names_to_points["EMR"] = kEMR;
