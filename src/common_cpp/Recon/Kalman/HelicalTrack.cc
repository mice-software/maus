...
// C_pred = _F * C * _Ft + _Q;
//
void HelicalTrack::calc_covariance(KalmanSite *old_site, KalmanSite *new_site) {
  TMatrixD C(5, 5);
...
void HelicalTrack::update_G(KalmanSite *a_site) {
...
void HelicalTrack::update_H(KalmanSite *a_site) {
...
void HelicalTrack::update_covariance(KalmanSite *a_site) {
...
// h1(a_1^0)
void HelicalTrack::calc_filtered_state(KalmanSite *a_site) {
  /////////////////////////////////////////////////////////////////////
  // PULL = m - ha
  //
  TMatrixD m(2, 1);
...
void HelicalTrack::update_back_transportation_matrix(KalmanSite *optimum_site,
...
void HelicalTrack::smooth_back(KalmanSite *optimum_site, KalmanSite *smoothing_site) {
