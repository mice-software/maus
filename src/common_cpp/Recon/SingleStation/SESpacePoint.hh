...
#ifndef SESPACEPOINT_HH
#define SESPACEPOINT_HH
...
class SESpacePoint {
 public:
  SESpacePoint(); // Default constructor

  SESpacePoint(SECluster *clust1, SECluster *clust2, SECluster *clust3);

  SESpacePoint(SECluster *clust1, SECluster *clust2);
  ...
  void set_channels(std::vector<SECluster*> channels) { _channels = channels; }
 ...
 private:
  ...
  std::vector<SECluster*>  _channels;
