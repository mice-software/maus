...
/** @class SciFiPlotterBase
 *
 *  Abstract base class for various classes which use ROOT to plot tracker data.
 *
 */

#ifndef _SRC_COMMON_CPP_RECON_SCIFI_SCIFIPLOTTERBASE_
#define _SRC_COMMON_CPP_RECON_SCIFI_SCIFIPLOTTERBASE_
