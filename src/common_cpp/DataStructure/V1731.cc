...
V1731::V1731()
    : _ldc_id(0), _max_pos(0), _part_event_number(0), _charge_mm(0),
      _equip_type(0), _channel_key(""), _charge_pm(0), _arrival_time(0),
      _phys_event_number(0), _position_min(0), _samples(), _time_stamp(0),
      _trigger_time_tag(0), _detector(""), _pulse_area(0), _geo(0),
