...
class SciFiTrack {
 public:
  ...
  void SetSeedState( std::vector<double> seed ) { this->_seed_state_vector = seed; }

  std::vector<double> GetSeedState() const { return _seed_state_vector; }
 ...
 private:
  ...
  std::vector<double> _seed_state_vector;
