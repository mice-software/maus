...
from ReducePyCkov import ReducePyCkov

class ReducePyCkovTestCase(unittest.TestCase): # pylint: disable=R0904, C0301
    """
    Test class for ReducePyCkov
    """
    ...
    def test_invalid_json(self):
        ...
        self.assertTrue("ReducePyCkov" in errors,
        ...
        self.assertEquals("<type 'exceptions.ValueError'>: \
                          ...
                          errors[0], "Unexpected error trace") # pylint: disable=C0301
    ...
    def __check_result(self, spill_id, result):
        ...
        """
        json_doc = ('%s/src/reduce/ReducePyCkov/processTest.txt' %
