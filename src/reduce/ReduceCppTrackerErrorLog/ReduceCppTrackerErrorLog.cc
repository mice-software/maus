...
void ReduceCppTrackerErrorLog::project4() {
  ...
  // composite frame
  TGCompositeFrame *fCompositeFrame709 = new TGCompositeFrame(fMainFrame1586,
                                                              486,
                                                              372,
                                                              kVerticalFrame);
  ...
  TGLabel *fLabel710 = new TGLabel(fCompositeFrame709,
                                   "SciFi Error Log",
  ...
  TGLabel *fLabel712 = new TGLabel(fGroupFrame711,
                                   "Tracker 0 Missing",
                                   uGC->GetGC(),
                                   ufont->GetFontStruct());
  ...
  TGLabel *fLabel713 = new TGLabel(fGroupFrame711,
                                   "Tracker 1 Missing",
                                   uGC->GetGC(),
                                   ufont->GetFontStruct());
  ...
  TGLabel *fLabel714 = new TGLabel(fGroupFrame711,
                                   "Diff numb evts in trackers",
                                   uGC->GetGC(), ufont->GetFontStruct());
  ...
  TGLabel *fLabel715 = new TGLabel(fGroupFrame711,
                                   "Bank Lenghts Mismatch",
                                   uGC->GetGC(), ufont->GetFontStruct());
  ...
  TGLabel *fLabel717 = new TGLabel(fGroupFrame711,
                                   "% of events",
                                   uGC->GetGC(), ufont->GetFontStruct());
  ...
  TGLabel *fLabel721 = new TGLabel(fCompositeFrame709,
                                   "Run number: 12345",
                                   uGC->GetGC(), ufont->GetFontStruct());
  ...
  TGLabel *fLabel722 = new TGLabel(fCompositeFrame709,
                                   "Numb events processed: 666",
                                   uGC->GetGC(), ufont->GetFontStruct());
  ...
  TGLabel *fLabel724 = new TGLabel(fGroupFrame723,
                                   "Massive event",
                                   uGC->GetGC(), ufont->GetFontStruct());
  ...
  TGLabel *fLabel725 = new TGLabel(fGroupFrame723,
                                   "Tracker 1 empty",
                                   uGC->GetGC(), ufont->GetFontStruct());
  ...
  TGLabel *fLabel726 = new TGLabel(fGroupFrame723,
                                   "Tracker 2 empty",
                                   uGC->GetGC(), ufont->GetFontStruct());
  ...
  TGLabel *fLabel728 = new TGLabel(fGroupFrame723,
                                   "% of events",
                                   uGC->GetGC(), ufont->GetFontStruct());
  ...
  std::string fname = std::string(pMAUS_ROOT_DIR) +
                      "/src/reduce/ReduceCppTrackerErrorLog/mice";
