...
class ReduceCppReconTesting {
 ...
 private:
  ...
  std::vector<double> _T0D;
  std::vector<double> _T1D;
  std::vector<double> _T2D;
  std::vector<double> _T10D;
  std::vector<double> _T21D;

  std::vector<std::pair<MAUS::DataStructure::Global::Track*, TNtuple> > _tracks;
  std::vector<std::pair<MAUS::DataStructure::Global::SpacePoint*, TNtuple> > _spacepoints;
