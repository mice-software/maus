...
from ReducePyKLPlot import ReducePyKLPlot

class ReducePyKLPlotTestCase(unittest.TestCase): # pylint: disable=R0904, C0301
    """
    Test class for ReducePyKLPlot
    """
    ...
    def test_invalid_json(self):
        ...
        self.assertTrue("ReducePyKLPlot" in errors,
                        "No ReducePyKLPlot field")        
        errors = errors["ReducePyKLPlot"]
