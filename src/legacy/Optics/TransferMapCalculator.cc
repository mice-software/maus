...
TransferMap TransferMapCalculator::GetPolynomialTransferMap(PhaseSpaceVector referenceIn, double targetZ, std::vector<double> delta, std::vector<double> magnitude)
{
  ...
  G4MICE::PolynomialVector* poly = diff->PolynomialFromDifferentials(CLHEP_to_MVector(referenceIn.getSixVector()) );
  TransferMap       map;
...
TransferMap TransferMapCalculator::GetPolynomialTransferMap(std::vector<PhaseSpaceVector> in, std::vector<PhaseSpaceVector> out, int order)
{
  ...
  G4MICE::PolynomialVector* poly  = G4MICE::PolynomialVector::PolynomialLeastSquaresFit(in_v, out_v, order);
  TransferMap       map;
  map.SetPolynomialVector(poly);
                                   ...
                                   int maxNumberOfSteps, PhaseSpaceVector refIn, PhaseSpaceVector refOut)
{
  ...
  G4MICE::PolynomialVector* pvec = G4MICE::PolynomialVector::Chi2SweepingLeastSquaresFitVariableWalls(*trackingOutput, order, std::vector< G4MICE::PolynomialVector::PolynomialCoefficient >(), 
