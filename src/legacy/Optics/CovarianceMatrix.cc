...
CovarianceMatrix::CovarianceMatrix(const CovarianceMatrix& covariances)
	: SymmetricMatrix((SymmetricMatrix) covariances)
{ }

CovarianceMatrix::CovarianceMatrix(const SymmetricMatrix& matrix)
	: SymmetricMatrix(matrix)
{ }

CovarianceMatrix::CovarianceMatrix(const ::CLHEP::HepSymMatrix& covariances)
	: SymmetricMatrix(covariances)
{ }

/*FIXME I'm not sure if these are needed.
