// @(#) $Id: Spline1D.hh,v 1.1 2005-10-28 08:22:42 rogers Exp $  $Name:  $
//
// ********************************************************************
// * DISCLAIMER                                                       *
// *                                                                  *
...
// The Spline1D class represents a table-driven cubic spline in 1 dimension.
...
// A related class is Spline, for an N-dimensional cubic spline taking
// an array instead of a value for x.  The general Spline class is correct
...
The Spline1D class is an object representing the transformation between some
...
A given instance of a Spline is constructed from:
