...
EmCalKLGlue::~EmCalKLGlue()
{
  miceMemory.addDelete( Memory::EmCalKLGlue ); 
...
//
//
EmCalKLGlue::EmCalKLGlue(MiceModule* mod, G4Material* mater, G4VPhysicalVolume *mlv )
{
  miceMemory.addNew( Memory::EmCalKLGlue ); 
