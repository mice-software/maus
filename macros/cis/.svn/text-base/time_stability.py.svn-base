...
#runs2 = [84450,72652 , 72653 , 72660 , 72661,  73305, 73314 , 73316 , 73742 , 73768 , 78017 , 78023, 78026, 78020 , 79121 , 79786 , 79789 , 79797 , 80487 , 80534 , 81342 , 81363 , 81601 , 81608 , 81627 , 83078 , 84402 , 84826 , 85889 , 79259, 87920 , 88366 , 90179 , 90364 , 90555 , 90860 , 92972 , 93399 , 93884 , 94115 , 99025 , 99026 , 99944 , 100008 , 100073 , 100266 , 101184 , 101441 , 101784 , 101785 , 102009 , 79781, ]#] up to calib\
...
extra = None#Use(run=runs2, runType='CIS', region=selected_region)
extra2 = None#ReadOldCISFile()

Go([u1, x1, ReadDB(),  CISRecalibrateProcedure(), extra, extra2, TimeStability(all=True)])
