...
if [ -n "${MAUS_ROOT_DIR+x}" ]; then
 ...
 command to redownload, or check" >&2; echo "FATAL: internet connection"  >&2; rm -f ${filename}; exit 1; }
    ...
    #
    # ls ${MAUS_ROOT_DIR}/third_party/bash | grep bash | sort| xargs -i echo '${MAUS_ROOT_DIR}/third_party/{}'
    #

    ${MAUS_ROOT_DIR}/third_party/01python.bash
    ${MAUS_ROOT_DIR}/third_party/02swig.bash
    ${MAUS_ROOT_DIR}/third_party/03jsoncpp.bash
    ${MAUS_ROOT_DIR}/third_party/10setuptools.bash
    ${MAUS_ROOT_DIR}/third_party/11gtest.bash
    ${MAUS_ROOT_DIR}/third_party/20gsl.bash
    ${MAUS_ROOT_DIR}/third_party/21root.bash
    ${MAUS_ROOT_DIR}/third_party/30clhep.bash
    ${MAUS_ROOT_DIR}/third_party/31geant4.bash
    ${MAUS_ROOT_DIR}/third_party/40python_extras.bash
    ${MAUS_ROOT_DIR}/third_party/50cloc.bash
    ${MAUS_ROOT_DIR}/third_party/51xboas.bash
    ${MAUS_ROOT_DIR}/third_party/60recpack.bash
