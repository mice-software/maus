...
if [ -n "${MAUS_ROOT_DIR+x}" ]; then
 ...
 command to redownload, or check" >&2; echo "FATAL: internet connection"  >&2; rm -f ${filename}; exit 1; }
    ...
    #
    # ls ${MAUS_ROOT_DIR}/third_party/bash | grep bash | sort| xargs -i echo {}   
    #

    ${MAUS_ROOT_DIR}/third_party/03python.bash
    ${MAUS_ROOT_DIR}/third_party/10swig.bash
    ${MAUS_ROOT_DIR}/third_party/11jsoncpp.bash
    ${MAUS_ROOT_DIR}/third_party/12setuptools.bash
    ${MAUS_ROOT_DIR}/third_party/20gsl.bash
    ${MAUS_ROOT_DIR}/third_party/21root.bash
    ${MAUS_ROOT_DIR}/third_party/22clhep.bash
${MAUS_ROOT_DIR}/third_party/23geant4.bash
${MAUS_ROOT_DIR}/third_party/24cloc.bash
${MAUS_ROOT_DIR}/third_party/26xboa.bash
27recpack.bash
28gtest.bash
30python_extras.bash
