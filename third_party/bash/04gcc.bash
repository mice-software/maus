...
if [ -n "${MAUS_ROOT_DIR+x}" ]; then
	...
	rm -Rf ${MAUS_ROOT_DIR}/third_party/build/${directory}
        ...
        sleep 1
        ./configure --with-gmp=${MAUS_ROOT_DIR}/third_party/install --with-mpfr=${MAUS_ROOT_DIR}/third_party/install --enable-languages=c,c++ --prefix=${MAUS_ROOT_DIR}/third_party/install
        echo "INFO: Making:"
        sleep 1
        make -j8
        ...
        make install
	cd ..
	rm compare # some stupid stray file
	echo
