...
if [ -n "${MAUS_ROOT_DIR+x}" ]; then
    ...
    then
        ...
        echo "INFO: Building xrootd"
        ./build/unix/installXrootd.sh ${MAUS_ROOT_DIR}/third_party/install/
        echo
        echo
        echo "INFO: Configuring ROOT:"
        echo
        sleep 1
        ...
        ./configure \
              --with-xrootd=${MAUS_ROOT_DIR}/third_party/install/xrootd-* \
              --enable-gsl-shared \
