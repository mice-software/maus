...
if [ -n "${MAUS_ROOT_DIR+x}" ]; then
  ...
  then
    ...
    sleep 1
    mkdir ${MAUS_ROOT_DIR}/third_party/build/gcc/
    tar xvfz ${MAUS_ROOT_DIR}/third_party/source/${filename} -C ${MAUS_ROOT_DIR}/third_party/build/gcc > /dev/null
    mv ${MAUS_ROOT_DIR}/third_party/build/gcc/${directory} ${MAUS_ROOT_DIR}/third_party/build/gcc/src
    mv ${MAUS_ROOT_DIR}/third_party/build/gcc/ ${MAUS_ROOT_DIR}/third_party/build/${directory}
    mkdir ${MAUS_ROOT_DIR}/third_party/build/${directory}/obj
    cd ${MAUS_ROOT_DIR}/third_party/build/${directory}/obj

    echo
    echo "INFO: Configuring:"
    echo
    sleep 1
    ../src/configure --prefix=${MAUS_ROOT_DIR}/third_party/install/ --with-mpfr-include=${MAUS_ROOT_DIR}/third_party/install/include/ --with-mpfr-lib=${MAUS_ROOT_DIR}/third_party/install/lib/ --with-gmp-include=${MAUS_ROOT_DIR}/third_party/install/include/ --with-gmp-lib=${MAUS_ROOT_DIR}/third_party/install/lib/ --with-mpc-include=${MAUS_ROOT_DIR}/third_party/install/include/ --with-mpc-lib=${MAUS_ROOT_DIR}/third_party/install/lib/ --disable-multilib
