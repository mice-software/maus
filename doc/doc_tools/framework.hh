/** @mainpage MAUS: MICE Analysis User Software - Framework

Welcome to the MAUS framework documentation!  This documentation documents the code within MAUS framework rather than explaining how to use the code.  If you want tutorials, documents explaining the structure of MAUS, or anything other than how classes and functions operation then you should consult the Wiki link above.
