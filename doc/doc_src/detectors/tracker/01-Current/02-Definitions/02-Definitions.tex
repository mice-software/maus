...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.7\textwidth,bb=0 40 500 290]%
      {02-Definitions/Figures/StnNum.jpg}
  \end{center}
  \caption{
     Schematic diagram of the MICE tracker.  
     The five stations are shown supported by the carbon-ﬁbre space
     frame, with ﬁbres omitted for clarity.
     The station numbering scheme is indicated together with the
     direction in which the clear-ﬁbre light-guides leave the tracking
     volume.
  }
  \label{Fig:StnNum}
\end{figure}
