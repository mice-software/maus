...
TEST_F(MiceModToG4SolidTest, checkDimTest) {
  ...
  ASSERT_THROW   ( MiceModToG4Solid::checkDim(&mod, 3), MAUS::Exception );
...
TEST_F(MiceModToG4SolidTest, buildWedgeTest) {
  ...
  ASSERT_THROW   ( sol = MiceModToG4Solid::buildWedge(&mod), MAUS::Exception );
...
TEST_F(MiceModToG4SolidTest, buildBoxTest) {
  ...
  if (sol!=NULL) delete sol; sol=NULL;
  mod.setProperty<CLHEP::Hep3Vector>("Dimensions",CLHEP::Hep3Vector(0., 1., 1.) );
  ASSERT_THROW   ( sol = MiceModToG4Solid::buildBox(&mod), MAUS::Exception );
  mod.setProperty<CLHEP::Hep3Vector>("Dimensions",CLHEP::Hep3Vector(1., 0., 1.) );
  ASSERT_THROW   ( sol = MiceModToG4Solid::buildBox(&mod), MAUS::Exception );
  mod.setProperty<CLHEP::Hep3Vector>("Dimensions",CLHEP::Hep3Vector(1., 1., 0.) );
  ASSERT_THROW   ( sol = MiceModToG4Solid::buildBox(&mod), MAUS::Exception );
...
TEST_F(MiceModToG4SolidTest, buildCylinderTest) {
  ...
  if (sol!=NULL) delete sol; sol=NULL;
  mod.setProperty<CLHEP::Hep3Vector>("Dimensions",CLHEP::Hep3Vector(0., 1., 1.) );
  ASSERT_THROW   ( sol = MiceModToG4Solid::buildCylinder(&mod), MAUS::Exception );
  mod.setProperty<CLHEP::Hep3Vector>("Dimensions",CLHEP::Hep3Vector(1., 0., 1.) );
  ASSERT_THROW   ( sol = MiceModToG4Solid::buildCylinder(&mod), MAUS::Exception );
}
...
TEST_F(MiceModToG4SolidTest, buildTubeTest) {
  ...
  ASSERT_THROW   ( sol = MiceModToG4Solid::buildTube(&mod), MAUS::Exception );
  mod.setProperty<CLHEP::Hep3Vector>("Dimensions",CLHEP::Hep3Vector(0., 1., 1.) );
  ASSERT_THROW   ( sol = MiceModToG4Solid::buildTube(&mod), MAUS::Exception );
  mod.setProperty<CLHEP::Hep3Vector>("Dimensions",CLHEP::Hep3Vector(1., 0., 1.) );
  ASSERT_THROW   ( sol = MiceModToG4Solid::buildTube(&mod), MAUS::Exception );
...
TEST_F(MiceModToG4SolidTest, buildSphereTest) {
  ...
  //Check we catch errors before G4 throws
  mod.setProperty<CLHEP::Hep3Vector>("Dimensions",CLHEP::Hep3Vector(2.,1.,-1.) );
  ASSERT_THROW( sol = MiceModToG4Solid::buildSphere(&mod), MAUS::Exception );
...
TEST_F(MiceModToG4SolidTest, buildPolyconeTest) {
  MiceModule mod;
  ASSERT_THROW(MiceModToG4Solid::buildPolycone(&mod), MAUS::Exception); //test properly in polycone.hh
}

TEST_F(MiceModToG4SolidTest, buildMultipoleTest) {
  MiceModule mod;
  ASSERT_THROW(MiceModToG4Solid::buildMultipole(&mod), MAUS::Exception); //test properly in multipole.hh
}
...
TEST_F(MiceModToG4SolidTest, buildTorusTest) {
  ...
  ASSERT_THROW(sol = (G4Torus*)MiceModToG4Solid::buildTorus(&mod1), MAUS::Exception);
  MiceModule mod2 = torus_module(-0.1, 1.0, 5.*deg, 10.*deg, 2.0);
  ASSERT_THROW(sol = (G4Torus*)MiceModToG4Solid::buildTorus(&mod2), MAUS::Exception);
  MiceModule mod3 = torus_module(0.5, 3.0, 5.*deg, 10.*deg, 2.0);
  ASSERT_THROW(sol = (G4Torus*)MiceModToG4Solid::buildTorus(&mod3), MAUS::Exception);
  MiceModule mod4 = torus_module(0.5, 0.25, 5.*deg, 10.*deg, 2.0);
  ASSERT_THROW(sol = (G4Torus*)MiceModToG4Solid::buildTorus(&mod4), MAUS::Exception);
  MiceModule mod5 = torus_module(0.5, 1.0, -1.*deg, 10.*deg, 2.0);
  ASSERT_THROW(sol = (G4Torus*)MiceModToG4Solid::buildTorus(&mod5), MAUS::Exception);
  MiceModule mod6 = torus_module(0.5, 1.0, 361.*deg, 10.*deg, 2.0);
  ASSERT_THROW(sol = (G4Torus*)MiceModToG4Solid::buildTorus(&mod6), MAUS::Exception);
  MiceModule mod7 = torus_module(0.5, 1.0, 5.*deg, -1.*deg, 2.0);
  ASSERT_THROW(sol = (G4Torus*)MiceModToG4Solid::buildTorus(&mod7), MAUS::Exception);
  MiceModule mod8 = torus_module(0.5, 1.0, 5.*deg, 361.*deg, 2.0);
  ASSERT_THROW(sol = (G4Torus*)MiceModToG4Solid::buildTorus(&mod8), MAUS::Exception);
}
...
TEST_F(MiceModToG4SolidTest, buildEllipticalConeTest) {
  ...
  ASSERT_THROW(sol = (G4EllipticalCone*)MiceModToG4Solid::buildEllipticalCone(&mod2), MAUS::Exception);
  MiceModule mod3;
