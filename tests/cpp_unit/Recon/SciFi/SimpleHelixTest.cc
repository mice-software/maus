...
class SimpleHelixTest : public ::testing::Test {
  protected:
    SimpleHelixTest()  {}
    virtual ~SimpleHelixTest() {}
    virtual void SetUp()    {}
    virtual void TearDown() {}
};

TEST_F(SimpleHelixTest, test_default_constructor) {
  SimpleHelix h1;
...
TEST_F(SimpleHelixTest, test_parameter_constructor) {
...
TEST_F(SimpleHelixTest, test_getters_setters_clear) {
  double Phi_0 = 1.0;
  double Phi_0_err = 0.1;
  double R = 2.0;
  double R_err = 0.2;
