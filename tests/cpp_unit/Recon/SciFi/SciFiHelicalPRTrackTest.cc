...
// namespace MAUS {
class SciFiHelicalPRTrackTest : public ::testing::Test {
  protected:
    SciFiHelicalPRTrackTest()  {}
    virtual ~SciFiHelicalPRTrackTest() {}
    virtual void SetUp()    {}
    virtual void TearDown() {}
};

TEST_F(SciFiHelicalPRTrackTest, test_default_constructor) {
...
TEST_F(SciFiHelicalPRTrackTest, test_parameter_constructor) {
...
TEST_F(SciFiHelicalPRTrackTest, test_simplefit_constructor) {
...
TEST_F(SciFiHelicalPRTrackTest, test_copy_constructor) {
...
TEST_F(SciFiHelicalPRTrackTest, test_equality_operator) {
...
TEST_F(SciFiHelicalPRTrackTest, test_setters_getters) {
  double x0      = 1.0;
  double y0      = 2.0;
  double z0      = 1100.0;
  double phi0    = 4.0;
