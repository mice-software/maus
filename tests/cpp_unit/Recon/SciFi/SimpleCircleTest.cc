...
TEST_F(SimpleCircleTest, test_default_constructor) {
  SimpleCircle circ1;
...
TEST_F(SimpleCircleTest, test_first_parameter_constructor) {
  double x0 = 1.0;
  double y0 = 2.0;
  double R = 3.0;
...
TEST_F(SimpleCircleTest, test_second_parameter_constructor) {
  double x0 = 1.0;
  double x0_err = 0.1;
  double y0 = 2.0;
  double y0_err = 0.2;
...
TEST_F(SimpleCircleTest, test_getters_setters_clear) {
  double x0 = 1.0;
  double x0_err = 0.1;
  double y0 = 2.0;
  double y0_err = 0.2;
