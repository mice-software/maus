...
TEST(PrimitivesProcessorsTest, DoubleJsonToCpp) {
  ...
  EXPECT_EQ(*value, 1.);
  delete value;
  EXPECT_THROW(proc.JsonToCpp(Json::Value("string")), MAUS::Exceptions::Exception);
}
...
TEST(PrimitivesProcessorsTest, StringJsonToCpp) {
  ...
  delete value;
  EXPECT_THROW(proc.JsonToCpp(Json::Value(1.)), MAUS::Exceptions::Exception);
}
...
TEST(PrimitivesProcessorsTest, UIntJsonToCpp) {
  ...
  EXPECT_THROW(proc.JsonToCpp(Json::Value(-1)), MAUS::Exceptions::Exception); // negative int
...
TEST(PrimitivesProcessorsTest, LLUIntJsonToCpp) {
  ...
  value_json = Json::Value("-0");
  EXPECT_THROW(proc.JsonToCpp(value_json), MAUS::Exceptions::Exception);
