...
TEST_F(ObjectProcessorTest, HasUnknownBranches) {
  ...
  EXPECT_THROW(not_req_proc.HasUnknownBranches(json_int), Exception);
  ...
  EXPECT_THROW(not_req_proc.JsonToCpp(json_object_1), Exception);
...
TEST_F(ObjectProcessorTest, JsonToCppRequiredTest) {
  ...
  EXPECT_THROW(req_proc.JsonToCpp(json_int), Exception);
  ...
  EXPECT_THROW(req_proc.JsonToCpp(json_object), Exception);
  ...
  EXPECT_THROW(req_proc.JsonToCpp(json_object_missing_a), Exception);
  ...
  EXPECT_THROW(req_proc.JsonToCpp(json_object_missing_b), Exception);
  ...
  EXPECT_THROW(req_proc.JsonToCpp(json_object_missing_c), Exception);
  ...
  EXPECT_THROW(req_proc.JsonToCpp(json_object_missing_d), Exception);
...
TEST_F(ObjectProcessorTest, JsonToCppNotRequiredTest) {
  ...
  json_object["branch_b"] = Json::Value(2.);
  json_object["branch_a"] = Json::Value("string");
  EXPECT_THROW(not_req_proc.JsonToCpp(json_object), Exception);
...
TEST_F(ObjectProcessorTest, CppToJsonRequiredTest) {
  ...
  // Check throw on NULL
  test.SetB(NULL);
  EXPECT_THROW(req_proc.CppToJson(test, ""), Exception);
}
