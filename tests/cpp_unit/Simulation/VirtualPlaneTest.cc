...
TEST_F(VirtualPlaneManagerTest, StartOfEventTest) {
  EXPECT_TRUE(false);
}

TEST_F(VirtualPlaneManagerTest, ModuleNameTest) {
  EXPECT_TRUE(false);
}

TEST_F(VirtualPlaneManagerTest, ModuleTest) {
  EXPECT_TRUE(false);
}

TEST_F(VirtualPlaneManagerTest, StationNumberTest) {
  EXPECT_TRUE(false);
}
