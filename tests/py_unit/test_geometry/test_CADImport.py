...
class  test_CADImport(unittest.TestCase):
    ...
    def test_Constructor(self):
        ...
        """
        try:
            self.Constructor = CADImport(xsl = self.xslt)
            self.assertTrue(False, "should have raised an exception")
        except:
            pass
        try:
            self.Constructor = CADImport(xmlin1 = "fastradModel.not_xml", xsl = self.xslt)
            self.assertTrue(False, "Should have raised an exception")
        except:
            pass
        """
        ...
        """
        try:
            self.Constructor = CADImport(xmlin1 = self.xml_in_1)
            self.assertTrue(False, "Should have raised an exception")
        except:
            pass
        try:
            self.Constructor = CADImport(xmlin1 = self.xml_in_1, xsl = "GDML2G4MICE.not_xsl")
            self.assertTrue(False, "Should have raised an exception")
        except:
            pass
        """
        ...
        """
        try:
            self.Constructor = CADImport(xmlin1 = self.xml_in_1, xsl = self.xslt)
            self.assertEqual(self.Constructor.XMLIn2, None, "default is not None")
        except:
            pass
        try:
            self.Constructor = CADImport(xmlin1 = self.xml_in_1, xsl = self.xslt, xmlin2 = 1)
            self.assertTrue(False, "Should have raised an exception")
        except:
            pass
        try:
            self.Constructor = CADImport(xmlin1 = self.xml_in_1, xsl = self.xslt, xmlin2 = "FieldInfoTest.not_xml")
            self.assertTrue(False, "Should have raised an exception")
        except:
            pass
        """
        ...
        try:
            ...
            pass
        try:
            self.Constructor = CADImport(xmlin1 = self.xml_in_1, xsl = self.xslt, output = 1)
            self.assertTrue(False, "Should have raised an exception")
        except:
            pass
        """
        ...
        """
        try:
            self.Constructor = CADImport(xmlin1 = self.xml_in_1, xsl = self.xslt, mergein = "something else")
            self.assertEqual(self.Constructor.MergeIn, "Merge.xsl.in", "default is not Merge.xsl.in")
        except:
            pass
        
        try :
            self.Constructor = CADImport(xmlin1 = self.xml_in_1, xsl = self.xslt, mergin = 1)
            self.assertTrue(False, "Should have raised an exception")
        except:
            pass
        """
        ...
        try:
            ...
            pass
        try:
            self.Constructor = CADImport(xmlin1 = self.xml_in_1, xsl = self.xslt, mergout = 1)
            self.assertTrue(False, "Should have raised an exception")
        except:
            pass
        try:
            self.Constructor = CADImport(xmlin1 = self.xml_in_1, xsl = self.xslt, mergeout = "MergedOut.not_xsl")
            self.assertTrue(False, "Should have raised an exception")
        except:
            pass
