...
cpp_unit_files = [
'MeshTest.cpp', 'MAUSPrimaryGeneratorActionTest.cpp', 'STLUtilsTest.cpp', 'BTSolenoidTest.cpp', 'JsonWrapperTest.cpp', 'MAUSTrackingActionTest.cpp', 'MAUSGeant4ManagerTest.cpp', 'BTMultipoleTest.cpp', 'MVectorTest.cpp', 'DifferentiatorTest.cpp', 'BTFieldConstructorTest.cpp', 'MMatrixTest.cpp', 'MiceModToG4SolidTest.cpp', 'PolynomialTest.cpp', 'BTTrackerTest.cpp', 'MAUSSteppingActionTest.cpp', 'CppErrorHandlerTest.cpp', 'MiceModuleTest.cpp', 'TriangularMeshTest.cpp', 'dataCardsTest.cpp', 
]
