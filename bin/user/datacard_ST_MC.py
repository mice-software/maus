...
keep_steps = False # set to true to keep start and end point of every track and
                   # every step point
simulation_geometry_filename = "TrackerStraightFitTest.dat" # geometry used by simulation
...
spill_generator_number_of_spills = 200
...
beam = {
    ...
    "binomial_n":25, # number of coin tosses
    "binomial_p":0.8, # probability of making a particle on each toss
